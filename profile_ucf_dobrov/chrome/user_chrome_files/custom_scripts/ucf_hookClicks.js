...
Setup = [{ // быстрые настройки. есть Def3el: несовпадения выделяются
	...
	pref: ["browser.display.use_document_fonts", "Загружать шрифты страниц"], Yellow: 0, refresh: true,
	keys: [[1, "Да"], [0, "Нет"]]
},{
	...
	upd(node) {
		...
		if ("Def3el" in pref)
			if (val == pref.Def3el)
				...
				node.style.filter = "drop-shadow(1px 1px 1px #F8F)";
			}
